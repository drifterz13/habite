...
class QuestsTest < ApplicationSystemTestCase
  ...
  test "should create quest" do
    ...
    fill_in "Completed at", with: @quest.completed_at
    fill_in "Description", with: @quest.description
    fill_in "End at", with: @quest.end_at
    fill_in "Start at", with: @quest.start_at
  ...
  test "should update Quest" do
    ...
    fill_in "Completed at", with: @quest.completed_at.to_s
    fill_in "Description", with: @quest.description
    fill_in "End at", with: @quest.end_at.to_s
    fill_in "Start at", with: @quest.start_at.to_s
    fill_in "Title", with: @quest.title
